define("company/sites-concated/sample1.com/index/js/init-sites-sample1com-index-debug", [ "company/widgets/header/js/init-header-debug", "jquery/jquery/1.10.1/jquery-debug", "company/javascript/my-util-debug", "company/widgets/body/js/init-body-debug", "company/widgets/footer/js/init-footer-debug" ], function(require, exports, module) {
    require("company/widgets/header/js/init-header-debug");
    require("company/widgets/body/js/init-body-debug");
    require("company/widgets/footer/js/init-footer-debug");
});

define("company/widgets/header/js/init-header-debug", [ "jquery/jquery/1.10.1/jquery-debug", "company/javascript/my-util-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    var complain = require("company/javascript/my-util-debug");
    complain();
    complain(1e8);
    seajs.log("loaded init-header done~~");
});
...
define("company/widgets/footer/js/init-footer-debug", [ "jquery/jquery/1.10.1/jquery-debug", "company/javascript/my-util-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    var complain = require("company/javascript/my-util-debug");
    complain();
    complain(1e8);
    seajs.log("loaded init-footer done~~");
});
